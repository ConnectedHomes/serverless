...
class Serverless {
  ...
  constructor(config) {
    ...
    this.classes.RuntimeNode10x     = require('./RuntimeNode10x')(this);
    this.classes.RuntimeNode12x     = require('./RuntimeNode12x')(this);
    this.classes.RuntimeNode14x     = require('./RuntimeNode14x')(this);
