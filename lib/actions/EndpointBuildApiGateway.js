...
module.exports = function(S) {
  ...
  class Builder {
    ...
    _fetchDeployedLambda() {
      ...
      // allow overriding function alias using -e flag or "functionAlias" stage-region variable
      // enables pointing a stages's API-GW at another stages lambdas
      let alias;
      if (_this.evt.options.aliasEndpoint) alias  = _this.evt.options.aliasEndpoint;
      else alias = _this.project.getRegion(_this.evt.options.stage, _this.evt.options.region).getVariables().functionAlias;

      let qualifier = alias || _this.evt.options.stage
      ...
      return _this.aws.request('Lambda', 'getFunction', params, _this.evt.options.stage, _this.evt.options.region)
        .then(function(data) {
          ...
          // Prepare StatementId
          // NOTE: previous version of string were prefixed with "s_apig"`
          _this.lambdaPolicyStatementId = ('s_apig2_' +  _this.restApi.id + '_' + _this.endpoint.path + '_' + _this.endpoint.method).replace(/[\/{}.]/g, '_');
    ...
    _getLambdaAccessPolicy() {
      ...
      return _this.aws.request('Lambda', 'getPolicy', params, _this.evt.options.stage, _this.evt.options.region)
        .then(function(data) {
          ...
          _this.deployedLambda.policyRevisionId = data.RevisionId;
        })
        .catch(function(e) {});
    }
    ...
    _removeLambdaPermissionForEndpoint() {
      ...
      let params = {
        ...
        RevisionId: _this.deployedLambda.policyRevisionId
        //Qualifier: 'STRING_VALUE'
      };
